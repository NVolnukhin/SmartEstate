                                ...
                                <div class="flat-info">
                                    ...
                                    <div class="flat-details">
                                        ...
                                        <div class="detail-item">
                                            ...
                                            <div class="detail-value">${flat1.roominess === -1 ? 'Студия' : flat1.roominess === -2 ? 'Своб. планировка' : `${flat1.roominess}-комнатная`}</div>
                                        </div>
                                        <div class="detail-item">
                            ...
                            <div class="flat-preview" data-id="${flat2.flatId}">
                                ...
                                <div class="flat-info">
                                    ...
                                    <div class="flat-details">
                                        ...
                                        <div class="detail-item">
                                            <div class="detail-label">Комнатность</div>
                                            <div class="detail-value">${flat2.roominess === -1 ? 'Студия' : flat2.roominess === -2 ? 'Своб. планировка' : `${flat2.roominess}-комнатная`}</div>
                                        </div>
                                        <div class="detail-item">
                                            <div class="detail-label">Этаж</div>
