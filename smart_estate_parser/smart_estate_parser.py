...
from smart_estate_parser.constants import CITIES, METRO_STATIONS, DEAL_TYPES, OBJECT_SUBURBAN_TYPES
from smart_estate_parser.url_builder import URLBuilder
from smart_estate_parser.proxy_pool import ProxyPool
from smart_estate_parser.flat.list import FlatListPageParser
...
class SmartEstateParser:
    ...
    def get_flats(self, deal_type: str, rooms, with_saving_csv=False, with_extra_data=False, additional_settings=None, district = None):
        ...
        self.__run__(
            __build_url_list__(location_id=self.__location_id__, deal_type=deal_type, accommodation_type="flat",
                               ...
                               additional_settings=additional_settings, district=district))
...
def __build_url_list__(location_id, deal_type, accommodation_type, rooms=None, rent_period_type=None,
                       suburban_type=None, additional_settings=None, district=None):
    ...
    if district is not None:
        url_builder.add_district(district)
