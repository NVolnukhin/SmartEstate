...
from smart_estate_parser.constants import FILE_NAME_FLAT_FORMAT
from smart_estate_parser.helpers import union_dicts, define_author, define_location_data, define_specification_data, define_deal_url_id, define_price_data
from smart_estate_parser.flat.page import FlatPageParser
from smart_estate_parser.base_list import BaseListPageParser
...
class FlatListPageParser(BaseListPageParser):
    ...
    def parse_offer(self, offer):
        ...
        common_data["district"] = self.district
